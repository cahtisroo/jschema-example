...
public class App {
    ...
    public static void main(String[] args) {
        ...
        get("/", (req, res) -> {
            ...
            return "<html><link href=\"main.css\" rel=\"stylesheet\" type=\"text/css\"><body><h1>Enter a stock ticker:</h1><form><input type='text' name='ticker' value='" + ticker + "'/><button>Submit</button></form><hr/><pre>" + result + "</pre></body></html>";
        } );
    }
